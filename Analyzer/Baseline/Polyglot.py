...
def Polyglot_Res(polyglot_variables, polyglot_results_update, sizeofTaint, Result_Format, Polyglot_length, Polyglot_keyword, Polyglot_separator):
    ...
    new_combined_format = []
    if Polyglot_combined_format == None:
        Polyglot_combined_format = []
    ...
    logging.info(f"merged_list:{merged_list}")
    ...
    logging.info("****************Polyglot********************")
    logging.info("Polyglot_length: {}".format(Polyglot_length))
    logging.info("Polyglot_keyword: {}".format(Polyglot_keyword))
    logging.info("Polyglot_separator: {}".format(Polyglot_separator))
    logging.info("==Fixed Field: {}".format(Result_Format))
    logging.info("==variables: {}".format(polyglot_variables))
    logging.info("Polyglot Combined Message Format: {}".format(Polyglot_combined_format))
...
def Pre_Processing(msgNums, threadId):
    ...
    logging.info("SizeOfTaint:{}".format(sizeofTaint))
...
def Seperator_Infer(payload_message, hashmap2, cmp_true):
    ...
    logging.info(f"Polyglot_Separator:{Polyglot_separator}")
